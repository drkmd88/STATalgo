...
# Compare with power.mcnemar.test
# https://github.com/cran/MESS/blob/master/R/power.mcnemar.test.R
library('MESS')
power_mcnemar_test(paid=0.125,psi=2,sig.level = 0.05,power=0.8,alternative='two.sided',method='normal')
